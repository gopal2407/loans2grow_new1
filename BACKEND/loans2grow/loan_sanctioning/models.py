...
class Loan(models.Model):
    ...
    status = models.CharField(max_length=250, choices=LOAN_STATUS_CHOICE, default=True)
...
class Vendor(models.Model):
    application = models.OneToOneField('application_generation.Application', on_delete=models.CASCADE, related_name='Vendors')
    name = models.CharField(max_length=150, default=0, blank=True)
    vendor_type = models.CharField(max_length=150, default=0, blank=True)
