    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('customer', 'customer'), ('loan_representative', 'loan_representative'), ('operational_head', 'operational_head'), ('loan_sanctioning_officer', 'loan_sanctioning_officer'), ('admin', 'admin'), ('account_head', 'account_head')], max_length=30, null=True)),
            ...
            managers=[
                ('objects', admin_app.manager.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Bank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spouse_name', models.CharField(blank=True, default='', max_length=20)),
