...
class Application(models.Model):
    ...
    pan_no =  models.CharField(max_length=12, default=0, blank=True)
    ...
    colletral = models.CharField(max_length=250, default=0, blank=True)
...
class Document(models.Model):
    ...
    three_years_itr_with_balance_sheet = models.FileField(upload_to='customer/document/', default=0, blank=True)
